    ...
    <section className="font-body">
      <div className="mt-0 md:mt-10">
        <h3 className="ml-10 text-3xl font-semibold dark:text-gray-100">
          Similar <span className="text-red-700 capitalize dark:text-red-500">Target Muscle</span> Exercises
        </h3>
      ...
      <div className="mt-10">
        <h3 className="ml-10 text-3xl font-semibold dark:text-gray-100">
          Similar <span className="text-red-700 capitalize dark:text-red-500">Equipment</span> Exercises
        </h3>
        <div className="flex flex-row p-1 relative">
          {targetMuscleExercises.length ? (
