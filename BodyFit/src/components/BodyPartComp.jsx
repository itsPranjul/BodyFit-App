...
const BodyPartComp = ({ item }) => {
  ...
  return (
    <button
      className={`flex flex-col items-center justify-center transition hover:scale-105 bg-gray-100 rounded-b-lg w-[270px] h-[280px] gap-y-12 shadow-lg border-solid border-red-700 dark:border-red-500 dark:bg-gray-900 ${
