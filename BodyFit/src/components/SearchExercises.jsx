        ...
        <form onSubmit={handleSearch} className="container mx-auto">
          ...
          <div className=" relative mx-auto w-11/12">
            ...
            <input
              ...
              id="default-search"
              className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-red-500"
              required
            />
            <button
